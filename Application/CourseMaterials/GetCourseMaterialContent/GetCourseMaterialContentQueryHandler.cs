...
public class GetCourseMaterialContentQueryHandler
    : IQueryHandler<GetCourseMaterialContentQuery, GetCourseMaterialContentResponseDto>
{
    ...
    public async Task<Result<GetCourseMaterialContentResponseDto>> Handle(
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new GetCourseMaterialContentResponseDto
        {
